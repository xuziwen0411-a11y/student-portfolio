/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc` (hash: 116567dbc8a75556f851ed1310e36495)
// Runtime types generated with workerd@1.20260515.1 2026-08-28 nodejs_compat
interface __BaseEnv_Env {
	MEDIA_KV: KVNamespace;
	DB: D1Database;
	ASSETS: Fetcher;
	AUTH_PLATFORM: "password";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./cloudflare/worker-entry");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_PLATFORM">> {}
}
